...
def upgrade(
    ...
    """
    Upgrade legacy filter-box charts to native filters.
    """
...
def downgrade(
    ...
    """
    Downgrade native filters to legacy filter-box charts (where applicable).
    """
...
def cleanup(
    ...
    """
    Cleanup obsolete legacy filter-box charts. Note this operation is irreversible.
    """
