...
class SupersetSecurityManager(  # pylint: disable=too-many-public-methods
    ...
    def get_guest_rls_filters(self, dataset: Union["AnnotationDatasource", "Query", "SqlaTable"]) -> List[GuestTokenRlsRule]:
        """
    ...
    def get_guest_rls_filters_str(self, datasource: Union["AnnotationDatasource", "Query", "SqlaTable"]) -> List[str]:
        return [f.get("clause", "") for f in self.get_guest_rls_filters(datasource)]

    def get_rls_cache_key(self, datasource: Union["AnnotationDatasource", "Query", "SqlaTable"]) -> List[str]:
        # pylint: disable=import-outside-toplevel
        from superset.connectors.sqla.models import SqlaTable
